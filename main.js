...
function mostraAlternativas(){
    for(const alternativas of perguntaAtual.alternativas){
        const botaoAlternativas = document.createElement("botao");
        const botaoAlternativas.textContent = alternativas.texto;
        const botaoAlternativas.addEventListener("click"),()=>respostasSelecionada(alternativas);
    }
}
function respostasSelecionada(opcaoSelecionada){
    const afirmacoes = opcapoSelecionada.afirmacao;
